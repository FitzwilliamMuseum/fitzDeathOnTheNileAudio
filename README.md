# Audio transcription from the Fitzwilliam Museum Death on the Nile Audioguide

An application for transcription of audio.
...
```bash
   $ git clone https://github.com/FitzwilliamMuseum/fitzDeathOnTheNileAudio.git applicationName
   $ cd applicationName
```
*  Now run:
```bash
